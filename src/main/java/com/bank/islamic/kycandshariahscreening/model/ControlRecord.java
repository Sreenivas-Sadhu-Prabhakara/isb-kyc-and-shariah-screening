package com.bank.islamic.kycandshariahscreening.model;
...
/**
 * The BIAN control record for this service domain: "KYC Shariah Assessment Procedure".
 *
 ...
 * to its asset type (KYC Shariah Assessment). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "KYC Shariah Assessment Procedure";
